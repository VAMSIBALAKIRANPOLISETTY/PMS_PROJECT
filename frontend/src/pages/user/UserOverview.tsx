import { Activity, ArrowRight, ClipboardList, FileText, Filter, HeartPulse, ShieldCheck, Upload } from "lucide-react";
import { Area, AreaChart, CartesianGrid, Line, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
import { DesignPicker } from "../../components/DesignPicker";
import { RiskPill } from "../../components/RiskPill";
import { StatCard } from "../../components/StatCard";
import type { Assessment, DesignId, Page, User } from "../../types";
...
export function UserOverview({ user, assessments, setPage, design, setDesign }: UserOverviewProps) {
